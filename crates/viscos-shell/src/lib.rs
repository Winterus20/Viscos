//! `viscos-shell` — native shell katmanı (Faz 1.0 stub).
//!
//! Faz 1.0 kapsamı:
...
//!
//! Faz 5'te `iced` ile tam native side panel + WebView overlay.
//! Faz 1.6'da `tao` + `wry` entegrasyonu (gerçek WebView oluşturma).
//!
//! Cross-references:
