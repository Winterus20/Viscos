//! `viscos-ipc` — pull-based IPC bridge between Rust backend ve Discord frontend.
//!
...
//! - `DefaultIpcRouter`: basit dispatch + NotImplemented stub'lar.
...
//! notification) push kalabilir. Tüm diğer state transferi pull.
//!
//! Cross-references:
